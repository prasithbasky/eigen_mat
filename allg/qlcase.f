C*****7**1*********2*********3*********4*********5*********6*********7**
      CHARACTER*(*) FUNCTION QLCASE ( ZEICHEN )
C
C
CA*   WANDELT ALLE BUCHSTABEN EINER ZEICHENKETTE IN KLEINBUCHSTABEN UM
C
CB*   NAME = QLCASE
C            ------
C
...
C
C
CM*   ACHTUNG:     GILT FUER ASCII-CODE
C     -------
C
C

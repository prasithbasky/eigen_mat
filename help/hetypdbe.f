C*****7**1*********2*********3*********4*********5*********6*********7**
      SUBROUTINE HETYPDBE ( TSTRING, CHREALD, IERR )
C
C
CA*   Unterprogramm zum Untersuchen von Teilstrings auf DOUBLE PRECISION
C     im D-Format 
C     
C
CB*   Name = HETYPDBE  Hilfsroutine zum Interpretieren von Teilstrings
C            --------  DOUBLE PRECISION Erkennung
C
C
...
C     -------
C
C     - CHREALD    REAL im D-Format
C                  CHREALE = 'D', d.h. eine DOUBLE PRECISION-Groesse liegt 
C                            vor im D-Format, wobei das D als grosser
C                            Buchstabe abgebildet ist.
C                  CHREALE = 'J', d.h. eine DOUBLE PRECISION Groesse
C                            wurde gefunden, wobei d als kleiner Buch-
C                            stabe abgebildet ist.
C                  CHREALE = 'N', d.h. keine DOUBLE PRECISION-Groesse 
C                             wurde gefunden
...
C                  CHREAL2 = 'd+'
C     - CHREAL3    erster Suchstring 
C                  CHREAL3 = 'D-'
C     - CHREAL4    zweiter Suchstring 
C                  CHREAL4 = 'd-'
C
CI*   COMMON:
C     ------
...
C                  nicht gefundene Typ im d-Format gesucht.
C                  
C
C
